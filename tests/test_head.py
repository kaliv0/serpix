...
def test_head_file_list_no_options() -> None:
...
def test_head_file_list_combined_options() -> None:
...
def test_head_file_list_non_existent_file() -> None:
...
def test_head_file_list_invalid_file_path() -> None:
    assert (
